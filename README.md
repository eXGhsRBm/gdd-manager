...
#### Categories
![Template editor — Categories](screenshots/template_categories.png)

#### Stages
![Template editor — Stages](screenshots/template_stages.png)

#### Documents
![Template editor — Documents](screenshots/template_documents.png)

### TOC editor
Manage the table of contents for each document.
Sections are ordered and validated for duplicates.

![TOC editor](screenshots/toc_editor.png)
