...
StageComboDelegate::StageComboDelegate(StagesTableModel *model,
                                       QObject *parent)
...
QWidget *StageComboDelegate::createEditor(QWidget *parent,
...
void StageComboDelegate::setEditorData(QWidget *editor,
...
void StageComboDelegate::setModelData(QWidget *editor,
